...
export const adminAdjustTickets = (data) =>
  api.post("/admin/tickets/adjust", data);
...
export const adminUpdateSiteSettings = (data) =>
  api.post("/admin/site-settings", data);

// Tournaments
export const getTournaments = () => api.get("/tournaments");
export const getTournament = (game) => api.get(`/tournaments/${game}`);
export const registerTeam = (data) =>
  api.post("/tournaments/register-team", data);
export const generateBracket = (game) =>
  api.post(`/tournaments/${game}/generate`);
export const updateMatchScore = (matchId, data) =>
  api.put(`/tournaments/match/${matchId}`, data);
export const resetTournament = (game) =>
  api.delete(`/tournaments/${game}/reset`);
...
export const getFestivalFinalesProposal = () =>
  api.get("/admin/festival-finales-proposal");
...
export const adminUpdateCagnotte = (data) =>
  api.post("/admin/cagnotte/update", data);
