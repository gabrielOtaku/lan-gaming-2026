...
const CONCEPT_BLOCKS = [
  ...
  },
  {
    ...
    body: `Lan St-Jean naît de l'ambition de reproduire la même vibe que cette première édition tant appréciée — mais en voyant les choses en bien plus grand. Notre but : faire de cet événement une histoire indélébile dont tout le monde se souviendra. Un week-end complet. Un maximum de guerriers. Que le grind commence.`,
    accent: '#FFD700',
    icon: '👑',
  },
];
