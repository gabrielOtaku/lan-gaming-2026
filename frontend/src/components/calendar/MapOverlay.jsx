...
const VENUES = [
  {
    ...
    description: 'Le cœur névralgique de l\'événement. Deux niveaux d\'activités avec la scène principale au niveau 1 et les arènes Valorant au niveau 2.',
    capacity: '200+ joueurs',
    stations: '80 postes gaming',
    wifi: 'Fibre 10 Gbps',
    color: '#C89B3C',
    icon: '🏛️',
    activities: ['Scène principale', 'Zone libre Niv.1', 'Arènes Valorant Niv.2', 'Espace partenaires'],
    floorPlans: {
      'Niveau 1': {
        zones: [
          { id: 'scene', label: 'Scène principale', x: 35, y: 20, w: 30, h: 25, color: '#FFD700' },
          { id: 'zone-libre', label: 'Zone libre', x: 10, y: 55, w: 35, h: 30, color: '#7C3AED' },
      ...
      'Niveau 2': {
        zones: [
          { id: 'valorant', label: 'Arènes Valorant', x: 10, y: 15, w: 80, h: 50, color: '#FF4655' },
  ...
  },
  {
    ...
    description: 'L\'arène principale de League of Legends. Configuration professionnelle avec scène surélevée, écrans géants et zone VIP.',
    capacity: '150 personnes',
    stations: '40 postes LoL',
    wifi: 'Fibre dédiée 5 Gbps',
    color: '#C89B3C',
    icon: '⚔️',
    activities: ['Tournoi LoL Phase groupes', 'Quarts de finale LoL', 'Demi-finales LoL', 'Grande Finale LoL'],
    floorPlans: {
      'Rez-de-chaussée': {
        zones: [
          { id: 'lol-a', label: 'Équipes A-D', x: 5, y: 10, w: 42, h: 35, color: '#C89B3C' },
          { id: 'lol-b', label: 'Équipes E-H', x: 53, y: 10, w: 42, h: 35, color: '#C89B3C' },
  ...
  },
  {
    ...
    name: 'Gymnase',
    floors: ['Rez-de-chaussée'],
    description: 'Espace multi-usages transformé en arène de football virtuel. Ambiance détendue, parfaite pour les tournois FIFA.',
    capacity: '100 personnes',
    stations: '20 consoles',
    wifi: 'Wi-Fi 2.4 / 5 GHz',
    color: '#00D4AA',
    icon: '🏆',
    activities: ['Tournoi FIFA / eFootball', 'Jeux consoles', 'Espace détente'],
    floorPlans: {
      'Rez-de-chaussée': {
        zones: [
          { id: 'fifa-1', label: 'Consoles bloc A', x: 5, y: 10, w: 40, h: 40, color: '#00D4AA' },
          { id: 'fifa-2', label: 'Consoles bloc B', x: 55, y: 10, w: 40, h: 40, color: '#00D4AA' },
