...
import { Menu, X, Sword, Zap, Ticket, Mail, Shield, LogOut, AlertCircle, ShoppingBag, Heart, Trophy, Crown, Info } from 'lucide-react';
...
const NAV_LINKS = [
  ...
  { to: '/boutique', label: 'Boutique', icon: ShoppingBag, code: 'SHOP' },
