...
router.get('/events', (_req, res) => {
  const events = [
    ...
    { id: 3,  date: '2026-10-09', startTime: '19:30', endTime: '22:30', title: 'Qualifications — Phase 1', description: 'Lancement des premiers matchs de qualification pour tous les tournois simultanément. Stream A (LoL) et Stream B (CS2) sur Twitch.', location: 'Toutes les arènes', category: 'tournament', color: '#C89B3C' },
    ...
    { id: 11, date: '2026-10-10', startTime: '20:00', endTime: '22:00', title: 'Quarts et demi-finales — Scène principale', description: 'Les matchs les plus attendus sur la scène principale, diffusés en direct sur Twitch avec commentateurs.', location: 'Salle Azimut — Scène principale', category: 'final', color: '#FFD700' },
